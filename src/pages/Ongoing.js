...
import AllOngoing from "../component/OngoingData";
...
function Ongoing(){
    const [ mcworkData, setworkData] = useState(AllOngoing);
         ...
         <Sidebar/>
          <main className="float-end content-wrapper">
             ...
             <section className="mail-sercotu d-inline-block w-100 mt-4">
                <div className="onisde ongingits d-inline-block w-100 position-relative"> 
                <DataTable
                    columns={columns}
                    data={mcworkData}
